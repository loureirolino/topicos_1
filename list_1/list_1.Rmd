...
data_1_dt = fread(list.files(dir_name, full.names = TRUE)[1],
                    select = c('estabelecimento_uf', 'vacina_descricao_dose', 'estabelecimento_municipio_codigo'),
                    encoding = 'UTF-8')

data_1_dt = data_1_dt[, estabelecimento_municipio_codigo := as.character(estabelecimento_municipio_codigo)]
data_1_dt = merge(data_1_dt, geobr::read_health_region(year = 2013, simplified = FALSE), by.x = 'estabelecimento_municipio_codigo', by.y = 'name_health_region')
