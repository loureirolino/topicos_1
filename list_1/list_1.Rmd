...
### Resolução 2.b)
```{r 2.b}
# Quantidade de vacinados por região de saúde, segunda dose (data.table)
data_1_dt_cut = data_1_dt[grepl('2', vacina_descricao_dose), .N , by = .(name_health_region)]

knitr::kable(data_1_dt_cut[order(-N)][1:5, ]) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"),
                full_width = TRUE,
                protect_latex = TRUE,
                position = 'center',
