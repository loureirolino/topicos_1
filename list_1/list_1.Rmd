...
### Resolução 1.a)
```{r 1.a, results='asis', class.source = "fold-show"}
...
# data_1 =vroom(entries[1], locale = locale("br", encoding = "latin1"),
#               num_threads = 3, delim = ";")
```
...
### Resolução 1.e)
```{r 1.e, eval=FALSE, class.source = "fold-show"}
# Criação de um df único a partir de todos os arquivos
files = fs::dir_ls(glob = paste0(dir_name, '/', 'file_*csv'))
data_complete = vroom(files, locale = locale("br", encoding = "latin1"),
               num_threads = 3, delim = ";")
```
